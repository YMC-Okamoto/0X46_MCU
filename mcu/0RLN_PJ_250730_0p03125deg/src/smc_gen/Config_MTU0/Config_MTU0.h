...
***********************************************************************************************************************/
#include "r_cg_mtu3.h"
#include "DEFINE_SETTING.h"						/* IFDEFê›íË */
...
Macro definitions
***********************************************************************************************************************/
#define MTU0_PCLK_COUNTER_DIVISION      (256)
/* óºÉGÉbÉW */
#define _007C_TGRD0_VALUE				(0x007CU) /* TGRD0 value */
#define _007C_TGRE0_VALUE				(0x007CU) /* TGRE0 value */
#define _007C_TGRF0_VALUE				(0x007CU) /* TGRF0 value */
