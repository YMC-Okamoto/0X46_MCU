...
void R_Config_S12AD0_Create(void)
{
    ...
    S12AD.ADCSR.WORD = _0000_AD_DBLTRIGGER_DISABLE | _0200_AD_SYNCASYNCTRG_ENABLE | _2000_AD_GROUP_SCAN_MODE;

    /* Set AD conversion start trigger sources */
    S12AD.ADSTRGR.WORD = 0x003FU | _0500_AD_TRSA_TRGA4N;									/* GroupA:MTU4íJÅAGroupB:NoTrigger */
    ...
    S12AD.ADANSA0.WORD = _0001_AD_ANx00_GROUPA_USED | _0002_AD_ANx01_GROUPA_USED | _0004_AD_ANx02_GROUPA_USED | 
                         _0008_AD_ANx03_GROUPA_USED;
    ...
    S12AD.ADCSR.WORD |= (_0000_AD_GBADI_DISABLE | _0000_AD_SCAN_END_INTERRUPT_DISABLE);
